                ...
                <div class="container px-0">
                    <nav class="navbar navbar-light bg-white navbar-expand-xl">
                        ...
                        <div class="collapse navbar-collapse bg-white justify-content-between mx-5"
                            ...
                            <div class="d-flex m-3 me-0 justify-content-center">
                                ...
                                <c:if test="${not empty pageContext.request.userPrincipal}">
                                    ...
                                    <div class="dropdown my-auto">
                                        <a href="/register" class="dropdown" role="button" id="dropdownMenuLink"
                                            data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="fas fa-user fa-2x"></i>
                                        </a>
                                        <ul class="dropdown-menu drop   down-menu-end p-4"
                                ...
                                <c:if test="${empty pageContext.request.userPrincipal}">
                                    <a href="/login" class="position-relative me-4 my-auto">
                                        <i title="Login" class="fa-solid fa-right-to-bracket"></i>
                                    </a>
                                </c:if>
                            </div>
                        </div>
