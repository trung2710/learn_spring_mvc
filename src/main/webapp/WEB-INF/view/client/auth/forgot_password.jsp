                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form:form method="post" action="/forgot-password" modelAttribute="newEmail">
                                        <c:set var="errorEmail">
                                            <form:errors path="confirmEmail" cssClass="invalid-feedback" />
                                        </c:set>
                                        <div class="form-floating mb-3">
                                            <form:input class="form-control ${not empty errorEmail ? 'is-invalid' : ''}"
                                                path="confirmEmail" type="email" />
