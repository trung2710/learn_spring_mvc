                                    ...
                                    <div class="row">
                                        <div class="col-12 mx-auto">
                                            <div class="d-flex justify-content-between">
                                                <h3>Detail Product with id=${id}</h3>
                                            </div>
                                            <hr>
                                            <div class="card" style="width: 60%;">
                                                <img class="card-img-top" src="/images/product/${item.image}"
                                                    alt="anh san pham">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">DetailDesc: ${item.detailDesc}</li>
                                                    <li class="list-group-item">ShortDesc: ${item.shortDesc}</li>
